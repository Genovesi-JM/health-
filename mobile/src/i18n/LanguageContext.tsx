...
const translations = {
  ...
  'clinician.nursing_records': { pt: 'Registos de enfermagem', en: 'Nursing records', fr: 'Dossier infirmier', es: 'Registros de enfermería', zh: '护理记录' },
  'clinician.add_record': { pt: 'Novo registo', en: 'New record', fr: 'Nouveau dossier', es: 'Nuevo registro', zh: '新建记录' },
  'clinician.care_tasks': { pt: 'Tarefas clínicas', en: 'Clinical tasks', fr: 'Tâches cliniques', es: 'Tareas clínicas', zh: '临床任务' },
  'clinician.complete': { pt: 'Concluir', en: 'Complete', fr: 'Terminer', es: 'Completar', zh: '完成' },
  'clinician.record_type': { pt: 'Tipo de registo', en: 'Record type', fr: 'Type de dossier', es: 'Tipo de registro', zh: '记录类型' },
  'clinician.record_assessment': { pt: 'Avaliação', en: 'Assessment', fr: 'Évaluation', es: 'Evaluación', zh: '评估' },
  'clinician.record_intervention': { pt: 'Intervenção', en: 'Intervention', fr: 'Intervention', es: 'Intervención', zh: '干预' },
  'clinician.record_handoff': { pt: 'Passagem de turno', en: 'Handoff', fr: 'Transmission', es: 'Relevo', zh: '交接' },
  'clinician.record_follow_up': { pt: 'Follow-up', en: 'Follow-up', fr: 'Suivi', es: 'Seguimiento', zh: '随访' },
  'clinician.assessment': { pt: 'Avaliação / intervenção', en: 'Assessment / intervention', fr: 'Évaluation / intervention', es: 'Evaluación / intervención', zh: '评估／干预' },
  'clinician.save': { pt: 'Guardar', en: 'Save', fr: 'Enregistrer', es: 'Guardar', zh: '保存' },
