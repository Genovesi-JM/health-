...
const styles = StyleSheet.create({
  ...
  title: { color: '#0f172a', fontSize: 27, fontWeight: '900', marginTop: 4 },
  ...
  kpiCard: { width: '48%', minHeight: 112, backgroundColor: '#fff', borderRadius: 14, padding: 14, borderWidth: 1, borderColor: '#e2e8f0', overflow: 'hidden' },
  kpiAccent: { position: 'absolute', top: 0, left: 0, right: 0, height: 3 },
  kpiValue: { fontSize: 27, fontWeight: '900', marginTop: 4 },
  kpiLabel: { color: '#64748b', fontSize: 11, lineHeight: 15, fontWeight: '700', marginTop: 7 },
