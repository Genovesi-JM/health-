...
DOCTOR_USERS: List[dict] = [
    {
        ...
        "profile": {
            ...
            "title": "Dr.",
            "slug": "carlos-mendonca",
            "bio": "Médico de clínica geral com 10 anos de experiência em Angola. Atendo adultos e crianças, presencialmente em Luanda e por teleconsulta.",
            "phone": "+244 923 456 789",
            "location_city": "Luanda",
            "location_province": "Luanda",
            "years_experience": 10,
            "accepts_new_patients": True,
            "consultation_types": ["teleconsulta", "presencial"],
            "languages": ["PT", "EN"],
            "price_min": 5000,
            "price_max": 12000,
    ...
    },
    {
        ...
        "profile": {
            ...
            "title": "Dra.",
            "slug": "ana-ferreira-cardiologia",
            "bio": "Cardiologista especializada em prevenção cardiovascular e reabilitação cardíaca. 15 anos de experiência em Luanda.",
            "phone": "+244 912 345 678",
            "location_city": "Luanda",
            "location_province": "Luanda",
            "years_experience": 15,
            "accepts_new_patients": True,
            "consultation_types": ["presencial"],
            "languages": ["PT", "FR"],
            "price_min": 10000,
            "price_max": 20000,
            "verification_status": "verified",
    ...
    try:
        for ddata in DOCTOR_USERS:
            ...
            doctor = Doctor(
                ...
                location_province=prof.get("location_province"),
                years_experience=prof.get("years_experience"),
                accepts_new_patients=prof.get("accepts_new_patients", True),
                consultation_types_json=json.dumps(prof.get("consultation_types", [])),
                languages_json=json.dumps(prof.get("languages", ["PT"])),
